...
module.exports = {
  ...
  safelist: [
    ...
    // Area colors from areaColors.ts
    ...
    'bg-azul', 'text-white', 'bg-magenta', 'text-black', 'bg-colorWpp',
    'bg-amarillo', 'text-black', 'bg-cian',
    ...
    'border-azul-cielo/20', 'border-azul-cielo/30', 'border-azul-cielo/50',
    'text-azul-oscuro', 'text-azul-marino', 'text-azul-marino/70', 'text-azul-marino/80',
    'text-azul-marino/60', 'text-azul-marino/50', 'placeholder-azul-marino/50',
  ],
  theme: {
    extend: {
      colors: {
