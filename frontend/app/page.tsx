...
import ServicioPage from "./servicios/page";
import Image from "next/image";

export default function Page() {
  return (
    <div className="container mx-auto flex flex-col items-center gap-12 py-12">
      <p className="text-lg">
        ...
        aquí para ayudar. Esperamos que esta página sea un recurso valioso para
        explorar todo lo que tenemos para ofrecer. Estamos comprometidos con su
        éxito y bienestar, y esperamos contribuir positivamente a su experiencia
        en el Centro de Procesos Industriales y Construcción del SENA.
      </p>
